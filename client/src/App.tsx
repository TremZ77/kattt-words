...
const AppContent: React.FC = () => {
    ...
    return (
      <div className="lobby">
        ...
        <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', gap: '1rem', width: '300px' }}>
          ...
          <button className="btn-primary" style={{ background: 'var(--accent-secondary)' }} onClick={handleOpenBrowser}>Browse Open Games</button>
  ...
  const isHost = players[0]?.id === socketId; // Host logic
    ...
    <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <header className="glass-panel" style={{ margin: '0.5rem', padding: '0.5rem 1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 50 }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          ...
          {gameState.gameStatus === 'LOBBY' && isHost && players.length >= 2 && players.every(p => p.isReady) && (
      ...
      <div className="glass-panel" style={{ margin: '0 0.5rem', padding: '0.5rem', overflowX: 'auto', zIndex: 40, maxHeight: '60px' }}>
            ...
            return (
              <div key={p.id} style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', lineHeight: 1 }}>
                  <span style={{ color: 'var(--accent-primary)' }}>{p.score}</span>
